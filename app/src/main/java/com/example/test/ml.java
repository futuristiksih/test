...
public class ml extends FragmentActivity {
    Button _cntButton2;
    String sendingId;
    TextView from;
    TextView to;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            classifier = new ImageClassifier(ml.this);
        } catch (IOException e) {
        ...
        _cntButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent activ = new Intent(ml.this, CameraActivity.class);
                startActivity(activ);
            }
        });
    }
    ...
    private void showToast(final String text) {
        final Activity activity = ml.this;
        if (activity != null) {
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ml.this);
        builder.setTitle("Add Photo!");
        builder.setItems(items, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int item) {
                boolean result = Utility.checkPermission(ml.this);
